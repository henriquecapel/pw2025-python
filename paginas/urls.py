...
urlpatterns = [
    ...
    path("cadastrar/portfolio/", PortfolioCreate.as_view(), name="cadastrar-portfolio"),
    ...
    path("excluir/portfolio/<int:pk>/", PortfolioDelete.as_view(), name="excluir-portfolio"),
    ...
    path("listar/portfolio/", PortfolioList.as_view(), name="listar-portfolio"),
]
